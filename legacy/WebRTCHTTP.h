...
-(id)init;-(id)initWithDefaultValue:(NSString*)endPointURL _token:(NSData *)token;
...
-(void)End;
//-(void)getIRISRegisterInfo:(NSString*)serverURL  _requestTimeoutInterval:(NSTimeInterval)timeoutInterval;
@end
