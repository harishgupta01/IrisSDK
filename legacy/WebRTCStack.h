...
@class WebRTCSession,SignalHandler,WebRTCHTTP,WebRTCStatsCollector, WebRTCStackConfig,WebRTCEventManager;
...
- (void) onWebSocketConnectedAndAuthenticated;
...
**
*/
@interface WebRTCStack : NSObject<WebRTCStreamDelegate,WebRTCHTTPDelegate,WebRTCEventManagerDelegate>
...
/* This is an API to initialize WebRTC IRIS stack for RTC 1.0 and 2.0
 Use initRTCGWithDefaultValue stackconfig option for RTC 1.0 - Channel based architecture
 Use initXMPPWithDefaultValue stackconfig option for RTC 2.0 */
...
/* API to regeister and create WebSocket connection */

//Get the register info and connect to websocket
