...
- (id)initXMPPWithDefaultValue:(NSData*)token _httpRequestURL:(NSString*)serverURL _userId:(NSString *)userId _statsURL:(NSString*)statsURL _usingRTC20:(BOOL)usingRTC20 _resourceURL:(NSString*)resourceURL _sourcePhoneNum:(NSString*)sourcePhoneNum _targetPhoneNum:(NSString*)targetPhoneNum _eventType:event;
